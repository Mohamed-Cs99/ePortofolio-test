...
export class IntensiveComponent {
  ...
  supportCategories:string[] | undefined;
  ...
  showSupportTypeCategories(supportType:string){
    ...
    else if (supportType === "Ventilation Support") {
      this.supportCategories = [
        "No assistance",
        "NIMV",
        "HFJV",
    ...
    else if (supportType === "Cardiovascular Support") {
      this.supportCategories = [
        "Inotropes and/or vasopressors",
        "Intra-aortic balloon"
      ];
    }
    else if (supportType === "Neurological Support") {
      this.supportCategories = [
    ...
    else if (supportType === "Liver Support") {
      this.supportCategories = [
        "MARS",
        "Prometheus"
      ];
    ...
    else if (supportType === "Renal Support") {
      this.supportCategories = [
        "Haemofilteration (UF)",
        "Haemodialysis (HD)",
        "CVVHF",
    ...
    else if (supportType === "Other support") {
      this.supportCategories = [
        "Plasmapheresis"
      ];
